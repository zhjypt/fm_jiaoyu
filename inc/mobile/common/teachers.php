 ...
 */
        ...
        $list = pdo_fetchall("SELECT * FROM " . tablename($this->table_teachers) . " WHERE weid = :weid AND schoolid =:schoolid AND is_show =:is_show ORDER BY sort DESC,id DESC", array(':weid' => $_W['uniacid'], ':schoolid' => $schoolid, ':is_show' => 0));
