...
var oss = 'http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/';
var images = {
	    localId: [],
	    serverId: []
};
...
var emojiUrl = 'http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/face/';
var extension = '.gif';
(function($){
  $.fn.emoji = function(){
...
function createEmojiBox(){
	...
	for(var i=0;i<emojiKeys.length;i++){
		...
		((i+1)==emojiKeys.length && emojiImgs.push('<img class="emojis" width="24" height="18" align="absmiddle" src="' + emojiUrl + "del.gif" +'" alt="删除" onclick="deleteEmoji();" />') && emojifoots.push('<img class="pageFoots" src="http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/check.png" />') && emojiImgs.push('</div>'))||((i+1)%20==0 && emojiImgs.push('<img class="emojis" width="24" height="18" align="absmiddle" src="' + emojiUrl + "del.gif" +'" alt="删除" onclick="deleteEmoji();" />')&& emojifoots.push('<img class="pageFoots" src="http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/check.png" />') && emojiImgs.push('</div><div class="emojiPage">'));
	}
	$("#emojisList").html(emojiImgs.join(''));
	$("#emojisFoot").html(emojifoots.join(''));
	if($(".pageFoots").length !=0){
		$(".pageFoots")[0].src="http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/checked.png";
	}
    ...
    try
    {
        ...
        if (x > startX) {
        	...
        	if(leftsize != 0){
        		...
        		$(".pageFoots").attr("src","http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/check.png");
        		$(".pageFoots")[pageFootNum].src="http://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/checked.png";
