	...
	if (!a.jQuery) {
		...
		function(a) {
			...
			if (d) {
				...
				else for (e in a) if (a.hasOwnProperty(e) && c.apply(a[e], d) === !1) break
			} else if (g) for (; e < f && c.call(a[e], e, a[e]) !== !1; e++);
			else for (e in a) if (a.hasOwnProperty(e) && c.call(a[e], e, a[e]) === !1) break;
			return a
				...
				try {
					...
					return function(b, c) {
						...
						var e, f = [],
							...
							i = h - g;
						if (i > 0) if (f = new Array(i), this.charAt) for (e = 0; e < i; e++) f[e] = this.charAt(g + e);
		...
		var A = y.CSS = {
			...
			Values: {
				...
				addClass: function(a, b) {
					if (a) if (a.classList) a.classList.add(b);
				...
				removeClass: function(a, b) {
					if (a) if (a.classList) a.classList.remove(b);
